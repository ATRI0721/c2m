          ...
          <div className="p-6 overflow-y-auto max-h-[60vh]">
            {server.tools.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <p>No tools available for this service</p>
              </div>
            )}
          </div>
        </div>
            ...
            <div className="sticky top-0 bg-white border-b border-surface-300 p-6 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-display font-semibold text-gray-900">MCP Services</h2>
                    <p className="text-xs text-gray-500">
                      {totalEnabledTools} {totalEnabledTools === 1 ? 'tool' : 'tools'} enabled
                    </p>
                  </div>
                </div>
                <button
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 flex-1">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-gray-500">{server.tools.length} {server.tools.length === 1 ? 'tool' : 'tools'}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
