...
export default function MCPPanel({ mcpServers, enabledServices, requiredServices, onToggleService }: MCPPanelProps) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-4 top-1/2 -translate-y-1/2 z-40 bg-white border border-surface-300 p-3 rounded-xl hover:border-primary-400 transition-all duration-200 shadow-soft"
        type="button"
        title="MCP 服务配置"
      >
        <div className="flex flex-col items-center gap-1">
          ...
          {totalEnabledTools > 0 && (
            <span className="text-xs font-bold text-primary-600">{totalEnabledTools}</span>
          )}
        </div>
      </button>
