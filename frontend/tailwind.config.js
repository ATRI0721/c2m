...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Gemini-inspired warm palette with golds and oranges
        primary: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      backgroundImage: {
        'gradient-subtle': 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)',
        'gradient-warm': 'linear-gradient(135deg, #fb923c 0%, #f97316 100%)',
        'gradient-cool': 'linear-gradient(135deg, #f472b6 0%, #ec4899 100%)',
